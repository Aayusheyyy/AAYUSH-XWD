...
logo=("""\n
      ...
      AAYUSH HO MUJI AAYUSH
                          
\033[1;37m----------------------------------------------
 AUTHOR     : AAYUSH
 GITHUB     : SECRET 
 FACEBOOK   : Ãáy Úśh
 DECODE BY  : AAYUSH DADA
\033[1;37m-----AAYUSH KO CMD USE GAR VAGYA REXA TERO MUJI-""")
def banner():
	print(logo)
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r {P}[AAYUSH]{P} {P}{loop}{P}/{P}{len(id)}{P} OK{P}[{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
